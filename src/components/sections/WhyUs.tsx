...
import { RevealText, SPRING, VIEWPORT, staggerContainer, useIsMobile } from '../ui/MotionKit';
            ...
            <div className="relative mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-5"
                    >
                        {[
                            ...
                            <motion.div
                                ...
                                className={`group bg-white/[0.02] max-md:backdrop-blur-sm backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 transition-[border-color] duration-300 cursor-default will-change-transform ${item.mt ? 'lg:mt-10' : ''}`}
                            >
                    ...
                    <div className="lg:sticky lg:top-32">
                        ...
                        >
                            <RevealText>
                                <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6 md:mb-8 leading-tight break-words hyphens-auto">Why companies pivot with us.</h2>
                            </RevealText>
                            <motion.p
