        ...
        <header className="sticky top-0 z-50 w-full border-b border-primary/10 bg-slate-900/80 backdrop-blur-md">
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                ...
                <div className="hidden md:flex items-center gap-8">
                    <a className="text-sm font-medium tracking-wide text-slate-300 hover:text-primary transition-colors" href="#approach">Approach</a>
                    <a className="text-sm font-medium tracking-wide text-slate-300 hover:text-primary transition-colors" href="#services">Services</a>
                    <a className="text-sm font-medium tracking-wide text-slate-300 hover:text-primary transition-colors" href="#success">Success Stories</a>
