...
const ShimmerText = ({ text }: { text: string }) => {
    ...
    return (
        <div className="relative cursor-default">
            <h1 className="relative z-10 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.1] tracking-tight text-slate-200 neo-kerning break-words hyphens-auto">
                {words.map((word, i) => (
